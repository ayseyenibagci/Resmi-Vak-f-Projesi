...
<div class="profil-wrapper">
    <div class="profil-header">
        ...
        <p class="text-muted">Bilgilerinizi güncelleyin, kendinizi güncel tutun.</p>
    </div>
    ...
    <form action="{{ route('kullanici.profil.guncelle') }}" method="POST" enctype="multipart/form-data">
        @csrf
    ...
    <div class="text-center mt-4">
        <a href="{{ route('kullanici.sifre.form') }}" class="btn btn-outline-danger">🔒 Şifreyi Değiştir</a>
    </div>
</div>
@endsection
